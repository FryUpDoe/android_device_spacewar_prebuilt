...
SPACEWAR_PREBUILT := device/nothing/spacewar-prebuilt
...
TARGET_PREBUILT_KERNEL := $(SPACEWAR_PREBUILT)/kernel/Image
TARGET_PREBUILT_DTB := $(SPACEWAR_PREBUILT)/kernel/dtb.img
BOARD_PREBUILT_DTBOIMAGE := $(SPACEWAR_PREBUILT)/kernel/dtbo.img
...
BOARD_PREBUILT_ODMIMAGE := $(SPACEWAR_PREBUILT)/odm.img
BOARD_PREBUILT_VENDORIMAGE := $(SPACEWAR_PREBUILT)/vendor.img

BOARD_SPACEWAR_DYNAMIC_PARTITIONS_PARTITION_LIST := odm product system system_ext vendor
BOARD_SUPER_PARTITION_SIZE := 6442450944
BOARD_SUPER_PARTITION_GROUPS := spacewar_dynamic_partitions
BOARD_SPACEWAR_DYNAMIC_PARTITIONS_SIZE := 6438256640

BOARD_PARTITION_LIST := $(call to-upper, $(BOARD_SPACEWAR_DYNAMIC_PARTITIONS_PARTITION_LIST))
